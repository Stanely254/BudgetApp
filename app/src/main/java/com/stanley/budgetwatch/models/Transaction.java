...
public class Transaction {
    ...
    public Transaction(final int i, final int type, final String description, final String account,
                       final String budget, final double value, final String note, final long dateMs, final String receipt) {
        id = i;
        this.type = type;
    ...
    public static Transaction toTransaction(Cursor cursor){
        ...
        return new Transaction(id, type, toBlankIfNull(description), toBlankIfNull(account), toBlankIfNull(budget),
                value, toBlankIfNull(note), dateMs, toBlankIfNull(receipt));
    }
}
