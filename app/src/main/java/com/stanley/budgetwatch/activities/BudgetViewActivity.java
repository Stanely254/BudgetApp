...
public class BudgetViewActivity extends AppCompatActivity {
    ...
    public void onResume(){
        ...
        if(_updateBudget || _viewBudget) {
            ...
            Budget existingBudget = dbHelper.getBudgetStoredOnly(_budgetName);
    ...
    private void doSave(){
        ...
        if(!_updateBudget) {
            dbHelper.insertBudget(budgetName, value);
        } else {
            dbHelper.updateBudget(budgetName, value);
        }
        finish();
    }
            ...
            case R.id.action_delete:
                ...
                builder.setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbHelper.deleteBudget(budgetName);
